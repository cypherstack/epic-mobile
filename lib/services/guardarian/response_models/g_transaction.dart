...
class GTransaction {
  ...
  final double expectedFromAmount;
  final double initialExpectedFromAmount;
  final String toCurrency;
  final String toNetwork;
  final String toCurrencyWithNetwork;
  final double toAmount;
  final String outputHash;
  final double expectedToAmount;
  final String location;
  final String createdAt;
  final String updatedAt;
  final int partnerId;
  final String externalPartnerLinkId;
  final double fromAmountInEur;
  ...
  static GTransaction fromMap(Map<dynamic, dynamic> map) {
    try {
      return GTransaction(
        ...
        fromAmount: map["from_amount"] as double,
        depositType: map["deposit_type"] as String,
        payoutType: map["payout_type"] as String,
        expectedFromAmount: map["expected_from_amount"] as double,
        initialExpectedFromAmount:
            map["initial_expected_from_amount"] as double,
        ...
        payout: Payout.fromMap(map["payout"] as Map<dynamic, dynamic>),
...
class EstimateBreakdown {
  ...
  static EstimateBreakdown fromMap(Map<dynamic, dynamic> map) {
    return EstimateBreakdown(
      toAmount: map["toAmount"] as double,
      fromAmount: map["fromAmount"] as double,
      serviceFees: map["serviceFees"] as List<dynamic>,
      convertedAmount: map["convertedAmount"] as Map<String, dynamic>,
      estimatedExchangeRate: map["estimatedExchangeRate"] as double,
